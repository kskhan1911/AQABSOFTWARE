...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Edit Income Source</h4><br><br>
    ...
    <form method="post" action="{{ route('customer.update') }}" id="myForm" enctype="multipart/form-data" >
            ...
            <div class="mb-3 row">
                <label for="example-text-input" class="col-sm-2 col-form-label">Income Source Name </label>
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Update Income Source">
            </form>
