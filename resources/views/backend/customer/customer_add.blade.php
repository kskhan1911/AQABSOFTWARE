...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Add Income Sources </h4><br><br>
    ...
    <form method="post" action="{{ route('customer.store') }}" id="myForm" enctype="multipart/form-data" >
            ...
            <div class="mb-3 row">
                <label for="example-text-input" class="col-sm-2 col-form-label">Income Sources Name </label>
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Add Income Sources">
            </form>
